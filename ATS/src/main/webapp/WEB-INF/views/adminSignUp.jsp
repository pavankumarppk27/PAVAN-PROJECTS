...
<body>
	...
	<h2 style="color:green">${msg}</h2>
					<div align="center">
					<fieldset>
			<legend><b>Create a New Account</b><br></legend>
			it's quick and easy.
			
				<br>	<br><br>	<br>
				<form:form action="/adminRegister" modelAttribute="userModel" method="post" id="userRegForm">
					<table>
